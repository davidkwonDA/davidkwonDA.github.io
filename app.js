...
document.getElementById("social1").onmouseover = function() {
  social_one.setAttribute("style","padding-bottom:0vw;opacity:0.3;width: 22vw;height: 0vw;font-size: 3.3vw;"); 
...
document.getElementById("social2").onmouseover = function() { 
  social_two.setAttribute("style","padding-bottom:0vw;opacity:0.3;width: 22vw;height:0vw;font-size: 3.3vw;");
...
document.getElementById("social3").onmouseover = function() { 
  social_three.setAttribute("style","padding-bottom:0vw;opacity:0.3;width: 22vw;height: 0vw;font-size: 3.3vw;");
...
document.getElementById("social4").onmouseover = function() { 
  social_four.setAttribute("style","padding-bottom:0vw;opacity:0.3;width: 22vw;height: 0vw;font-size: 3.3vw;");
